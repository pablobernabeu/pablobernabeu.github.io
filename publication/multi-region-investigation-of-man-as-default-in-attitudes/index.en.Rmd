...
<div class="mermaid">
graph TD
  A["Survey of over 5000 people across more than 40 regions"] --> B["Globally distributed laboratory network"]
  B --> C["Measure attitudes toward each group and toward its men and women"]
  C --> D["Stronger link with the men: Black people, politicians"]
  C --> E["Stronger link with the women: White people"]
  C --> F["No difference: East Asian people, police officers, criminals"]
  C --> G["Regional agreement with traditional gender roles explored as moderator"]
</div>
```
