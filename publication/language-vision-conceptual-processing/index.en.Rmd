...
<div class="mermaid">
graph TD
  A["Three datasets: semantic priming, semantic decision, lexical decision"] --> B["Add language-based and vision-based measures"]
  B --> C["Mixed-effects models across individuals, words and tasks"]
  C --> D["Language-based information more important than vision-based"]
  C --> E["Priming: both stronger when words shown faster"]
  C --> F["Higher-vocabulary readers show a task-relevance advantage"]
  C --> G["Power: 300 participants for language effects; over 1,000 for vision effects"]
</div>
```
