...
featured: no
image:
  caption: 'Wikimedia Commons (https://commons.wikimedia.org/wiki/File:Charmers_Cafe_on_a_quiet_morning.jpg)'
  focal_point: ''
  preview_only: no
projects: []
---
...
![Two side-by-side condition summary tables: left (aggregated, n=23) shows non-significant CIs; right (inflated n) shows false significance.](inflated.jpg)

<img style = "float: right; margin-left: 30px;" width = '30%' src='SD.jpg' alt="Standard deviation formula: SD equals the square root of the sum of squared deviations from the mean divided by n." />
