...
<div style = "color: #308212; font-weight: bold; font-size: 18px; text-align: center; padding-top: 35px;"> Please allow a few seconds for loading. </div>
...
properties$main = recode(properties$main, Auditory = "a", Haptic = "h", Visual = "v")
...
concepts$main = recode(concepts$main, Auditory = "a", Haptic = "h", Visual = "v")
