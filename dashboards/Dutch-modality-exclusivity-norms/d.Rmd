...
[Webpage](https://pablobernabeu.github.io){target="_top"}
...
# 
#                   <p style="font-size:11px !important; padding-bottom:4px;">* Calculated following <a href="#section-references"> Lynott and Connell (2009, 2013)</a>.</p>
# 
...
# 
#                   <p><i class="fas fa-book-open"></i> <a href="#section-references">References</a></p>
# 
#                   </div>'))
#   })
...
### <span style = 'font-size: 16px !important;'> Principal component analysis (PCA) reflecting different relationships among the modalities. The visual and haptic modalities were related, whereas the auditory modality was more independent (see PCA loadings below; cf. <a href="#cf-lc-english-norms">Lynott & Connell's 2009 data for English</a>). <a href="https://osf.io/ge7pn/" target="_top">CSV</a> and <a href="https://osf.io/58gzs/" target="_top">Excel spreadsheet</a> also available. [External corpora used](#external-corpora).</span> {style="text-align:justify; padding-top: 30px !important; padding-bottom: 5px !important; padding-left: 4px !important; padding-right: 4px !important;"}
...
ggplotly(
  ggplot( props, aes(RC1, RC2, label = as.character(word), color = main, 
    ...
    theme( plot.background = element_blank(), panel.grid.major = element_blank(),
           ...
           legend.background = element_rect(size = 2), legend.title = element_blank(),
