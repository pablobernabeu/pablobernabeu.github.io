...
![Panels of fixed effects across 7 optimizers, all converging to nearly identical values on a shared Y axis](XYQDug2.png)<!-- -->
...
![Fixed effects across 7 optimizers on plot-specific Y axes zoomed to 7 decimals, showing tiny differences between optimizers](BYXJYxM.png)<!-- -->
