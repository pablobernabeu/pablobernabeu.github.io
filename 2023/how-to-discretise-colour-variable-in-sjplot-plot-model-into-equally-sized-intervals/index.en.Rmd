...
aliases:
  ...
  - /2023/how-to-break-up-colour-variable-in-sjplot-into-equally-sized-bins/
categories:
  - R
  - statistics
tags:
  ...
  - s
subtitle: ''
summary: 'Custom functions that extend sjPlot to discretise continuous variables in interaction plots into equally-sized intervals (deciles or sextiles) that include minimum and maximum values, with legend counts showing sample sizes per level.'
authors: []
...
![sjPlot line chart of predicted fatigue versus spin with default trait colour bins at 8.9, 20.5 and 32.1](7VTcfLu.png)<!-- -->
...
![Predicted fatigue versus spin with trait split into ten equal deciles (1.00 to 40.00), legend showing n=8 IDs per bin](niqWOzx.png)<!-- -->
...
![Predicted fatigue versus spin with trait split into six equal sextiles (1.00 to 40.00), legend showing ID counts per bin](w8Ydo4F.png)<!-- -->
