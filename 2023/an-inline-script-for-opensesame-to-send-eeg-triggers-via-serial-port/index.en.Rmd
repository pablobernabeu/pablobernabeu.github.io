...
aliases:
  - /2023/an-inline-script-for-opensesame-to-send-eeg-triggers-via-the-serial-port/
categories:
  - research methods
tags:
  ...
  - s
subtitle: ''
summary: 'Python inline script for OpenSesame that sends EEG triggers via serial port for event-related potential experiments, adapting solutions from various platforms to work with serial rather than parallel ports.'
authors: []
lastmod: ''
featured: no
draft: no
