...
![sjPlot interaction plot of predicted angle vs temperature, legend 'recipe_recoded' showing sum-coded values -0.5, 0, 0.5](SiigAMp.png)<!-- -->
...
![Same interaction plot with custom function, legend 'recipe' showing original values A, B, C instead of sum-coded ones](SS03gK6.png)<!-- -->
