...
[![Two-panel interaction plot of predicted reaction time by language-based similarity (a) and visual-strength difference (b), lines coloured by SOA of 200 vs 1200 ms](Screenshot 2022-12-27 234345.png){width=550px}](https://github.com/pablobernabeu/language-sensorimotor-simulation-PhD-thesis/blob/main/semanticpriming/frequentist_analysis/plots/semanticpriming-interactions-with-SOA.pdf)
